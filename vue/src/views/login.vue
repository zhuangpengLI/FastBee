...
<div class="login">
        ...
        <el-row :gutter="10">
            ...
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
                    ...
                    <h3 class="bindAccountTitle" v-else>绑定智能家居账户</h3>
    ...
    <div class="el-login-footer">
        <span>Copyright © 2018-2023 <a target="_blank" href="">zhinengjiaju</a> All Rights Reserved.</span>
    </div>
</div>
</template>
