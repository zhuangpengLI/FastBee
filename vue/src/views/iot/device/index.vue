...
<!-- 
    <el-card style="padding-bottom:100px;">
      ...
      <el-table-column label="设备所在地址" align="center" prop="networkAddress" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            type="text"
            icon="el-icon-link"
            :style="{ display: scope.row.belongFamilyId===null?'none':''}"
            @click="handleUnbinding(scope.row)"
            v-hasPermi="['iot:device:unbinding']"
          >解绑</el-button>
          <el-button
            size="mini"
            type="text"
    ...
    <!--上报数据对话框 -->
      ...
      >
        ...
        >
          ...
          <el-table-column label="备注" align="center" prop="remark" />
           <el-table-column label="上报时间" align="center" prop="alertTime" width="180">
        <template slot-scope="scope">
...
import { listDeviceShort, delDevice,unbindingDevice ,alertList} from "@/api/iot/device";
...
export default {
  ...
  methods: {
    ...
    handleUnbinding(row) {
      ...
      this.$modal
        .confirm('确认是否解绑sn:' + serialNumber + '的设备？')
        .then(function () {
          return unbindingDevice(deviceIds);
        })
        .then(() => {
          this.getList();
