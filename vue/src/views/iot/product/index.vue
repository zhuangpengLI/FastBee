<template>
  <div style="padding: 6px">
    <el-card style="margin-bottom: 5px">
      ...
      >
        ...
        <el-form-item label="状态" prop="status">
          ...
          >
            <el-option
              v-for="dict in dict.type.iot_product_status"
              :key="dict.value"
              :label="dict.label"
              :value="dict.value"
            />
    ...
    <!-- <el-row :gutter="30" v-loading="loading" >
        ...
        <pagination v-show="total>0" :total="total" :page.sync="queryParams.pageNum" :limit.sync="queryParams.pageSize" :pageSizes="[10, 20, 30, 50]" @pagination="getList" />
         -->
    <el-table v-loading="loading" :data="productList">
      ...
      <el-table-column label="产品型号" align="center" prop="deviceModelType" />
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.iot_product_status"
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            >删除</el-button
          >
          <!-- <el-button size="mini" type="warning" icon="el-icon-search" @click="handleViewDevice(scope.row.productId)" v-hasPermi="['iot:device:query']">查看设备</el-button> -->
          <el-button
            type="info"
            size="mini"
            style="padding: 5px"
            @click="changeProductStatus(scope.row.productId, 1)"
          ...
          <el-button
            ...
            size="mini"
            style="padding: 5px"
            @click="changeProductStatus(scope.row.productId, 2)"
            v-if="scope.row.status == 1"
            >发布产品</el-button
          >
          <!-- </el-button-group> -->
