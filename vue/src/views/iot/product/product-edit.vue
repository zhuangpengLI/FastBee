          ...
          <el-row :gutter="100">
            <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
              ...
              <el-form-item label="联网方式" prop="networkMethod">
                ...
                >
                  <el-option
                    v-for="dict in dict.type.iot_network_method"
                    :key="dict.value"
                    :label="dict.label"
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
              ...
              <el-form-item label="认证方式" prop="vertificateMethod">
                ...
                >
                  <el-option
                    v-for="dict in dict.type.iot_vertificate_method"
                    :key="dict.value"
                    :label="dict.label"
                    :value="parseInt(dict.value)"
                  ></el-option>
              ...
              <el-form-item label="产品型号" prop="deviceModelType">
                <el-input
...
export default {
  ...
  created() {
    //新增前先清空数据,防止未按返回列表返回的数据 仍然在新增的时候为上一次编辑的数据
    // this.reset();
    // // 获取分类信息
  ...
  methods: {
    ...
    changeInputType(name) {
      if (name == "key") {
        this.keyInputType =
          this.keyInputType == "password" ? "text" : "password";
      } else if (name == "account") {
        this.accountInputType =
          this.accountInputType == "password" ? "text" : "password";
