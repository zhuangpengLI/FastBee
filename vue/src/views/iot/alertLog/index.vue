...
<div style="padding:6px;">
    ...
    <el-card style="padding-bottom:100px;">
        <el-table v-loading="loading" :data="alertLogList" @selection-change="handleSelectionChange" border>
            ...
            <el-table-column label="位置" align="center" prop="familyPosition" />
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    ...
                    :style="{ display: scope.row.status==2?'':'none'}"
                    @click="handleUpdate(scope.row)" v-hasPermi="['iot:alertLog:edit']">处理</el-button>
                </template>
            </el-table-column>
        </el-table>
