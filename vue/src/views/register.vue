...
<div class="register">
        ...
        <el-row :gutter="10">
            <el-col :xs="24" :sm="24" :md="14" :lg="14" :xl="14">
                <div class="login-top hidden-sm-and-down">
                    <h1>
                        <a href="https://wumei.live/" target="_blank" style="color:#FFF;">智能家居系统</a>
                        -
                        <a href="https://wumei.live/" target="_blank" style="color:#FFF;">智能家居系统</a>
                    </h1>
            ...
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form" style="z-index:1000">
                    ...
                    <h3 class="title" v-else>注册绑定智能家居系统账户</h3>
    ...
    <div class="el-register-footer">
        <span>Copyright © 2018-2023 <a target="_blank" href="http://wumei.live">wumei smart</a> All Rights Reserved.</span>
    </div>
</div>
</template>
