    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        httpSecurity
                ...
                .antMatchers("/login", "/register", "/captchaImage","/iot/tool/register","/iot/tool/ntp","/iot/tool/download",
                        "/iot/tool/mqtt/auth","/iot/tool/mqtt/webhook","/auth/**/**"
                        ,"/mobile/loginCode","/mobile/login").anonymous()
                //匿名或非匿名访问
                .antMatchers("/mobile/tool/download","/mobile/agreement/getInfo"
                		,"/mobileSocket","/mobileSocket/**").permitAll()
                .antMatchers(
                        HttpMethod.GET,
                        "/",
                        "/*.html",
