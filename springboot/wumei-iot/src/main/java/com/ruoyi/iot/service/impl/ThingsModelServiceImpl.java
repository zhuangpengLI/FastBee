...
public class ThingsModelServiceImpl implements IThingsModelService 
{
    ...
    @Override
    public ThingsModel selectThingsModelByIdentifier(@Param("productId")Long productId,@Param("identifier")String identifier)
    {
    	return thingsModelMapper.selectThingsModelByIdentifier(productId,identifier);
    }
