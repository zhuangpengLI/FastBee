...
public class ProductServiceImpl implements IProductService 
{
    ...
    @Override
    public Product selectProductByDeviceModelType(String deviceModelType)
    {
    	return productMapper.selectProductByDeviceModelType(deviceModelType);
    }
    @Override
    public Product selectGwProductByDeviceModelType()
    {
    	return productMapper.selectGwProductByDeviceModelType();
    }
