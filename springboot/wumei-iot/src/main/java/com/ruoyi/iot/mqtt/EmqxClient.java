...
public class EmqxClient {
    ...
    public EmqxClient(String clientId,String username,String password,String hostname,
                      int timeout,int keepalive,boolean clearSession,String shortClientId){
        ...
        if (client == null){
            try {
              /*host为主机名，clientId是连接MQTT的客户端ID，MemoryPersistence设置clientId的保存方式
                ...
                logger.info("mqtt客户端创建参数=======>>>{},{},{},{}",hostname,clientId,emqxCallback,clearSession);
    ...
    private void setOptions(){
        ...
        logger.info("mqtt参数设置=============>{},{},{},{}",username,password,timeout,keepalive);
