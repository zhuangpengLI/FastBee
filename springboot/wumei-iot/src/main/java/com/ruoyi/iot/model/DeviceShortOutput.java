...
public class DeviceShortOutput
{
    ...
    //家庭名称
    private String belongFamilyName;
    //家庭管理员名称
	...
	public String getBelongFamilyName() {
		return belongFamilyName;
	}

	public void setBelongFamilyName(String belongFamilyName) {
		this.belongFamilyName = belongFamilyName;
	}
