...
public class MySqlLogServiceImpl implements ILogService {
    ...
    @Override
    public List<DeviceLog> selectDeviceLogListWithUserInfo(DeviceLog deviceLog) {
    	return deviceLogMapper.selectDeviceLogListWithUserInfo(deviceLog);
    }
    @Override
    public List<DeviceLog> selectAllDeviceLogListWithUserInfo(DeviceLog deviceLog) {
    	return deviceLogMapper.selectAllDeviceLogListWithUserInfo(deviceLog);
    }
