...
//    }
    @PreAuthorize("@ss.hasPermi('iot:alert:list')")
    @GetMapping("/list")
    public TableDataInfo list(AlertLogAndFamilyWithUser alertLog)
    {
    	startPage();
    	List<AlertLog> list = alertLogService.selectAlertLogWithInfoList(alertLog);
    	return getDataTable(list);
    }
